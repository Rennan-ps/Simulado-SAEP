...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $idade = $_POST['idade'];
    $email = $_POST['email'];
    $curso = $_POST['curso'];  // Captura corretamente o valor do campo curso
    ...
    $stmt->bind_param("sissi", $nome, $idade, $email, $curso, $id);  // Certifique-se de usar "sissi" para os tipos de dados corretos
